...
const /** {String} */ $noteCreateBtns = document.querySelectorAll('[data-note-create-btn]');
...
/**
 * The client object manages interaction with the user interface (UI) to create, read, update, and delete notebooks and notes.
...
export const client = {
    ...
    note: {
        ...
        /**
         * Updates a note in the UI based on provided note data.
         * 
