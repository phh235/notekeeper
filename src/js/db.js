...
export const db = {
    ...
    get: {
         ...
         * 
         * @function
         * @retunrns {Array<Object>} An array of notebook objects.
         */
        notebook() {
            readDB();
         ...
         * 
         * @function {string} notebookId - The ID of the notebook to retrieve notes from.
    ...
    update: {
         ...
         * @param {Object} The updated notebook object. 
         */
