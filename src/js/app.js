...
/**
 * Create new notebook
 * Creates a new notebook when the 'Enter' key is pressed while editing notebook name field.
...
const createNotebook = function (event) {
    ...
    if (event.key === 'Enter') {
        ...
        const /** {Object} */ notebookData = db.post.notebook(this.textContent || 'Untitiled'); // this: $navItemField 
