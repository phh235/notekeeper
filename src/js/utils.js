 ...
 * @param {string} eventType - They type of event to listen for (e.g., 'click', 'mouserover').
...
/**
 * Generators a greeting message based on the current hour of the day.
 * 
...
/**
 * Activates a navigation item by adding the 'active' class and deactivites the previously active item.
 */
 ...
 * 
 * @returns {string} A string representaion of the current timestamp.
*/
 ...
 * 
 * @param {Object} db - The object containing an aray of notebooks. 
 * @param {string} notebookId - The ID of the notebook to find.
